...
class ReferenceModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        print(f"[CAT]init reference model from {pretrain}")
...
class RewardModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        print(f"[CAT]init reward model from {pretrain}")
        self._setup_distributed(strategy)
        ...
        print(f'[CAT] RM getting tokenizer')
        self.tokenizer = get_tokenizer(pretrain,self.model)
