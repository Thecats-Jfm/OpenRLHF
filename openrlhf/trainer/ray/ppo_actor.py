...
class ActorPPOTrainer(PPOTrainer):
    ...
    def ppo_train(self):
        ...
        if self.critic_train_remote:
            print("[CAT] triger remote critic model training")
...
class ActorModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        print('[CAT] init actor model from {}'.format(pretrain))
        ...
        # configure tokenizer
        print('[CAT] PPO ACTOR get tokenizer')
    ...
    def prepare_datasets(self):
        ...
        # prepare datasets
        print(f'[CAT] prepare prompt datasets from {args.prompt_data}')
        ...
        print(f"[CAT] prompt dataset size: {len(prompts_dataset)}")
